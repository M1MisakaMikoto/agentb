...
def get_allowed_tools(agent_type: str, settings_service=None, use_settings_override: bool = False) -> List[str]:
    ...
    default_permissions = {
        ...
        "sub_agent": ["read_file", "write_file", "list_dir", "thinking", "chat", "document", "bridge_report_parser", "calculate_bci", "predict_trend", "query_standard", "list_workspace_files", "get_workspace_info", "submit_ai_judgment_issue", "submit_facility_report", "rag_search"],
        ...
        "prediction_agent": ["document", "read_file", "thinking", "chat", "bridge_report_parser", "calculate_bci", "predict_trend", "query_standard", "list_workspace_files", "get_workspace_info", "update_todo", "submit_ai_judgment_issue", "submit_facility_report", "rag_search"],
