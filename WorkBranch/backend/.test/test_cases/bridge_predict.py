...
PREDICTION_PROMPT = """⚠️ 重要指令：必须使用 Prediction Sub-Agent 完成任务！
...
3. 使用 predict_trend 工具基于历史BCI数据预测2024年的技术状况和退化趋势
4. 使用 query_standard 工具查询 CJJ 99-2017 等相关规范依据
5. 基于以上分析结果, 使用 document 工具(operation=w)生成完整的2024年预测报告

报告文件名: 2024年陈家阁大桥检测报告预测.docx
